# cockpit-provisioning Specification

## Purpose

Define hardened Cockpit provisioning: a localhost-only socket, a dedicated administrator with Vault-backed credentials, explicit SSH denial for that account, documentation, and idempotent convergence.
